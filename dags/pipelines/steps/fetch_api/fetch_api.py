...
def get_related_tables(table_name: str, tables):
    related_tables = {}
...
def get_related_tables_with_distance(table_name: str, tables, distance: int, related_tables = {}):
    ...
    for related_talbe in current_related_tables[table_name]["incoming"] or current_related_tables[table_name]["outgoing"]:
...
def main(table_name, distance=1):
    ...
    related_tables = getRelatedTablesWithDistance(table_name, tables, distance)
